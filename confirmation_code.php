		...
		<div class="col-xs-6 col-sm-6 col-md-6 mx-auto ">
			<div class="card mb-3 animated bounceInRight">
				<div class="card-header border-10 border-danger bg-success">
					<h3 style="color:white"><i class="fa fa-lock"></i> Activation Code </h3>

    </div>
    <div class="card-body">
	<!--<h6 class="text-center" style="color:red"> Search here for required term report </h6>-->
    <div class="row">
    <form class="mx-auto col-md-6" method="post" action="add_code.php">
		<div class="form-group">
			<label for="code">Code:</label>
			<input type = "text" name = "serial_no" placeholder = "Enter Code" id = "code" class = "form-control">
		</div>
			<button type="submit" class="btn btn-primary btn-block" name="submit"><i class="fa fa-lock"></i> SUBMIT</button>
    </form>
