...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="#" class="logo"><img src=assets/images/voc.jpg  alt="Profile image" class="avatar-rounded"> <span>Student</span></a>
        </div>
  ...
  'success'
        ...
        //check more info about this command
        $select_all         =   "SELECT DISTINCT surname,firstname,email,department,academic_session,term FROM result ORDER BY email";
        $select_query       =   $conn->query($select_all);
    ...
    ?>
                <tr>
                    ...
                    <td><a href='check_result.php?session=<?php echo $row['academic_session']; ?>&term=<?php echo $row['term'];?>&email=<?php echo $row['email'];?>&dept=<?php echo $row['department'];?>'><button class='btn btn-outline-info btn-sm' type='button'><i class='fa fa-pencil' aria-hidden='true'></i>check Result</button></a>

                    <a href="delete_user_result.php?email=<?php echo $row['email'];?>" onclick="return confirm('Do you want to delete this student?')" ><button class='btn btn-outline-info btn-sm' type='button'>
                    <i class="fa fa-trash" aria-hidden='true'></i>Delete Result</button></a>
