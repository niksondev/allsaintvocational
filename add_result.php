...
<div id="main">
  ...
  'success'
        ...
        $select_all         =   "SELECT * FROM student_registration ORDER BY surname ASC";
    ...
    ?>
                <tr>
                    ...
                    <td><a href='add_student_result.php?surname=<?php echo $row['surname']; ?>&firstname=<?php echo $row['firstname'];?>&email=<?php echo $row['email'];?>&dept=<?php echo $row['department'];?>'><button class='btn btn-outline-info btn-sm' type='button'><i class='fa fa-pencil' aria-hidden='true'></i>Add Result</button></a>

                    <a href="delete.php?email=<?php echo $row['email'];?>" onclick="return confirm('Do you want to delete this student?')" ><button class='btn btn-outline-info btn-sm' type='button'>
                    <i class="fa fa-trash" aria-hidden='true'></i>Delete User</button></a>
