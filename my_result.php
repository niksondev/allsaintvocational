                ...
                <ul class="list-inline float-right mb-0">
                    <li class="list-inline-item dropdown notif">
                        <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src='assets/images/<?php echo $row['passport'];?>' class="avatar-rounded">
                        </a>
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="breadcrumb-holder">
                                ...
                                <?php
                                    ...
                                    $user_email		=	$_SESSION['student_email'];
                                    $conn			=	mysqli_connect('localhost','root','','allsaints');
                                    $select			=	"SELECT * FROM result WHERE email = '$user_email'";
                            ...
                            <ol class="breadcrumb float-right">
                                ...
                                <li class="breadcrumb-item active">Welcome, <?php if(isset($_SESSION['name'])){echo $_SESSION['name'].' '.$_SESSION['fname'];}else{echo '';} ?></li>
            ...
            <div class="card mb-3 mx-auto animated bounceInBottom" style="width:97%">
                ...
                <div class="card-header border-10 border-danger">
                    ...
                    <h3 style="color:#079a07"><i class="fa fa-user"></i> Term Report:
                        ...
                        <span style="color:red"><?php if(isset($_SESSION['name'])){echo $_SESSION['name'].' '.$_SESSION['fname'];}else{echo 'The results for this term and session have not been uploaded';} ?></span><span class="pull-right"><button type="button" href="" onclick="window.print();" class="btn btn-primary"><i class="fa fa-print "></i> Print Report Card</button></span>
                    ...
                    <div class="row py-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-weight-bold h5">
                                            ...
                                            <?php if(isset($_SESSION['name'])){echo $_SESSION['name'].' '.$_SESSION['fname'];}else{echo ' ';} ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <?php if(isset($_SESSION['dept'])){echo $_SESSION['dept'];}else{echo "";} ?>
                                        </td>
                        ...
                        <div class="col-md-4">
                            ...
                            <?php
                                ...
                                while($row = $image_query->fetch_assoc()){
                            ?>
                            <img class='mb-2 float-right' style='max-width:180px; height:auto; ' src='assets/images/<?php echo $row['passport'];?>' />
                            <?php } ?>
                        </div>
