        ...
        <div class="left main-sidebar">
            ...
            <div class="sidebar-inner leftscroll">
                ...
                <ul>
                        ...
                        <li class="submenu">
                            <a href="#" class = "active"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
                        </li>

                        <li class="submenu">
                            <a href="user_info.php"><i class="fa fa-fw fa-user-o"></i><span> Users Information </span> </a>
                        </li>

                        <li class="submenu">
                            <a href="#" ><i class="fa fa-fw fa fa-group"></i> <span> Role </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li class="active fa fa-fw fa fa-money"><a href="borrower_details.php">Borrower</a></li>
                                    <li class="fa fa-fw fa fa-database"><a href="investor_details.php">Lender (investor)</a></li>
                                    <li class="fa fa-fw fa fa-briefcase"><a href="guarantor_details.php">Underwriter (Guarantor)</a></li>
                                </ul>
                        </li>

                        <li class="submenu">
                            <a href="add_admin.php"><i class="fa fa-fw fa-user-o"></i><span> Add Admins </span> </a>
                        </li>

                        <li class="submenu">
                            <a href="verification.php"><i class="fa fa-fw fa-user-o"></i><span> Users Verification </span> </a>
                        </li>

                        <li class="submenu">
                            <a href="verification_list.php"><i class="fa fa-fw fa-vcard"></i><span> Verification List </span> </a>
                        </li>

                        <li class="submenu">
                            <a href="reset_admin.php"><i class="fa fa-fw fa-user-o"></i><span> Reset Password </span> </a>
                        </li>
        ...
        <div class="card-body">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td>
                    <a href="delete_code.php?code_id=<?php echo $row['id']; ?>" onclick="return confirm('Do you want to unverified the user?')" ><button class='btn btn-outline-info btn-sm' type='button'>
