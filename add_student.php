							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
								<div class="card mb-3 mx-auto" style="width:97%">
									<div class="card-header border-10 border-danger">
										<h3 style="color:#079a07"><i class="fa fa-user"></i> All Saints School of Vocational Studies, Nnewi
                                        </h3>
									</div>
									<div class="card-body">
			<div class="alert alert-success hide"></div>	                          
	<form id="user_form" novalidate action="admin_register.php"  method="post" enctype="multipart/form-data" autocomplete="on">	
        <fieldset>
